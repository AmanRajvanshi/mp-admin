										...
										<div class="d-flex w-100 justify-content-between">
											<div class="active-project-1 d-flex align-items-center" style="margin-bottom:10px">
												...
												<div class="data-content">
													<div>
														<span class="font-weight-bold"><a href="view-customer.php" target="blank">Christian Bale</a></span>
													</div>
												</div>
											</div>
									...
									<div class="card-body">
										...
										<table id="datatable-1" class="table data-table table-striped table-bordered">
											...
											<tr>
												...
												<td>
													<button type="button" class="btn btn-primary btn-sm mt-2"><a href="single-reported-feeds.php" style="color:white" target="_blank">View</a></button>
												</td>
											</tr>
											</tbody>
										</table>
