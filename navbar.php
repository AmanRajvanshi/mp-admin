	...
	<div class="iq-navbar-custom">
		<nav class="navbar navbar-expand-lg navbar-light p-0">
			<div class="side-menu-bt-sidebar">
				<svg xmlns="http://www.w3.org/2000/svg" class="wrapper-menu" width="30"
						...
						<li class="nav-item nav-icon dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
								<li class="dropdown-item d-flex svg-icon">
									...
									<a href="https://templates.iqonic.design/datum/html/app/user-profile.html">My
										Profile</a>
								</li>
								<li class="dropdown-item d-flex svg-icon">
									...
									<a
										href="https://templates.iqonic.design/datum/html/app/user-profile-edit.html">Edit
										Profile</a>
								</li>
								<li class="dropdown-item d-flex svg-icon">
									...
									<a
										href="https://templates.iqonic.design/datum/html/app/user-account-setting.html">Account
										Settings</a>
								</li>
								<li class="dropdown-item d-flex svg-icon">
									...
									<a
										href="https://templates.iqonic.design/datum/html/app/user-privacy-setting.html">Privacy
										Settings</a>
								</li>
