                    ...
                    <table class="table data-table mb-0 table-bordered table-striped ">
                      ...
                      <tbody>
                        <tr class="white-space-no-wrap">
                          ...
                          <td>
                            <div class="d-flex justify-content-end align-items-center">
                              <button type="button" class="btn btn-primary btn-sm mr-1"><a href="view-content.php" style="color:white;" target="_blank">View Content</a></button>
                              <button type="button" class="btn btn-warning btn-sm mr-1"><a href="view-on-map.php" style="color:white;" target="_blank">View On Map</a></button>
                              <button type="button" class="btn btn-info btn-sm mr-1"><a href="edit-pending-verifications.php" style="color:white" target="_blank">Edit</a></button>
                        ...
                        <tr class="white-space-no-wrap">
                          ...
                          <td>
                            <div class="d-flex justify-content-end align-items-center">
                              <button type="button" class="btn btn-primary btn-sm mr-1"><a href="view-content.php" style="color:white;text-decoration:none;">View Content</a></button>
              ...
              <div class="card card-block card-stretch">
                <div class="card-body p-0">
                  <div class="d-flex justify-content-between align-items-center p-3">
                    ...
                    <button class="btn btn-secondary btn-sm">
                      <a href="add-active-vendors.php" style="color:white">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="17">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                        </svg>
                        Add
                        ...
                        <tr class="white-space-no-wrap">
                          ...
                          <td>
                            <div class="d-flex justify-content-end align-items-center">
                              <button type="button" class="btn btn-primary btn-sm mr-1"><a href="view-content.php" style="color:white;" target="_blank">View Content</a></button>
                              <button type="button" class="btn btn-warning btn-sm mr-1"><a href="view-on-map.php" style="color:white;" target="_blank">View On Map</a></button>
                              <button type="button" class="btn btn-info btn-sm mr-1"><a href="edit-active-vendors.php" style="color:white" target="_blank">Edit</a></button>
                              <button type="button" class="btn btn-danger btn-sm mr-1" onclick="return confirm ('Are You sure you want to delete?')">Delete</button>
                            </div>
                          </td>
                        </tr>
              ...
              <div class="card card-block card-stretch">
                <div class="card-body p-0">
                  <div class="d-flex justify-content-between align-items-center p-3">
                    ...
                    <button class="btn btn-secondary btn-sm">
                      <a href="add-blocked-vendors.php" style="color:white">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="17">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                        </svg>
                        Add
                        ...
                        <tr class="white-space-no-wrap">
                          ...
                          <td>
                            <div class="d-flex justify-content-end align-items-center">
                              <button type="button" class="btn btn-primary btn-sm mr-1"><a href="view-content.php" style="color:white;" target="_blank">View Content</a></button>
                              <button type="button" class="btn btn-warning btn-sm mr-1"><a href="view-on-map.php" style="color:white;" target="_blank">View On Map</a></button>
                              <button type="button" class="btn btn-info btn-sm mr-1"><a href="edit-blocked-vendors.php" style="color:white" target="_blank">Edit</a></button>
                              <button type="button" class="btn btn-danger btn-sm mr-1" onclick="return confirm ('Are You sure you want to delete?')">Delete</button>
                            </div>
                          </td>
                        </tr>
