							...
							<div class="card-body p-0">
								<div class="d-flex justify-content-between align-items-center p-3">
									...
									<button class="btn btn-secondary btn-sm">
										<a href="create-user.php" style="color:white;" target="_blank">
                        ...
                        <tr class="white-space-no-wrap">
                          ...
                          <td>
                            <div class="d-flex justify-content-end align-items-center">
                              <button type="button" class="btn btn-primary btn-sm mr-1"><a href="view-user.php" style="color:white;" target="_blank">Login</a></button>
                              <button type="button" class="btn btn-info btn-sm mr-1"><a href="edit-user.php" style="color:white" target="_blank">Edit</a></button>
